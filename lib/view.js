...
function view (obj) {
  ...
  let tags = Array.from(new Set(obj.filter( item => item.tags !== '').map( item => { return item.tags})));
  let sendObj = {
    statusCode: 200,
      ...
      <body>
        <div class="container pt-3 pb-5">
          ...
          <form id="searchItem" class="mb-3">
            ...
            <span class="text-success">&#9632; noch 2 Wochen</span> &nbsp;
            <span class="text-warning">&#9632; nur noch 1 Wochen</span> &nbsp;
            <span class="text-danger">&#9632; abgelaufen</span>
            <span class="text-out">&#9632; aus</span>
          </form>
          ...
          <button type="button" class="btn-sm btn-primary mt-3" data-toggle="modal" data-target="#exampleModal">
            Vorrat hinzufügen
          </button>
        </div>
        ...
        <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
          <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h4 class="modal-title" id="exampleModalLabel">Vorrat hinzufügen</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
                </button>
              </div>
        ...
        <script>
          var categories = [${categories.map(item => {return '"'+item+'"'})}];
        </script>
